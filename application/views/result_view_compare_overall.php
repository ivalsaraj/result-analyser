...
<?php
	...
	$perd=number_format(($result1->grandtotal/4000*100)-($result2->grandtotal/4000*100),2);
	if($perd>0)
	...
	<p id="stotal"><b>'.$result1->grandtotal.'</b>/4000</p>
	</div>
	</td>
	<td>
	...
	<p id="stotal"><b>'.$result2->grandtotal.'</b>/4000</p>
	</div>';
	?>
	<style type="text/css">
	#sname {
	...
	$('#circle1').circleProgress({
        value: <?php echo ($result1->grandtotal/4000*100)/100; ?>,
        size: 150,
        fill: {
            <?php echo $grad1; ?>
        }
	...
	$('#circle2').circleProgress({
        value: <?php echo ($result2->grandtotal/4000*100)/100; ?>,
        size: 150,
        fill: {
            <?php echo $grad2; ?>
        }
