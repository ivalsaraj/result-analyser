...
//die(var_dump($arrcount));
$arrcount1=$arrcount;
//faild hv arraycount 11 
if($arrcount<=6){
	$escaped_values[6]=0;
	$escaped_values[7]='F';
}else $escaped_values[7]='P';
//calculate %
$per=$escaped_values[5]/500*100;
$per=number_format($per,2);
$escaped_values[8]=$per;
...
//die(var_dump($values));
$sql = "INSERT INTO student6
VALUES ($reg,'$values')";
//die($sql);
if ($conn->query($sql) === TRUE) {
    echo $escaped_values[0]."'s record fetched successfully<br>";
} else {
