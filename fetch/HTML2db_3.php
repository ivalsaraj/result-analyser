<?php
	...
	/*********************************************/
  // new dom object
function HTMLExtract($fileName,$rowCond=0,$reg,$tableName="student3")
 {
 //echo $reg;
  if($fileName!=null)
  {
...
if($arrcount!=11){
	...
	$escaped_values[10]="$sum";
	$escaped_values[11]='F';
}else $escaped_values[11]='P';
//calculate %
$per=$escaped_values[10]/700*100;
$per=number_format($per,2);
$escaped_values[12]="$per";
//die(var_dump($escaped_values));
